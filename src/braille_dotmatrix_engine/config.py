...
class BrailleArtConfig:
    ...
    @property
    def dot_diameter_mm(self) -> float: return self.geometry.dot_diameter_mm
    @property
    def dot_spacing_mm(self) -> float: return self.geometry.dot_spacing_mm
    @property
    def dot_radius_mm(self) -> float: return self.geometry.dot_radius_mm
    @property
    def safety_gap_mm(self) -> float: return self.geometry.safety_gap_mm
